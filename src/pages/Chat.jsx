...
const Chat = () => {
  ...
  return (
    ...
    >
      <Navbar />
      <div className="px-5 pt-5 pb-6 bg-black overflow-hidden" />
      <div className="overflow-y-scroll scroll-smooth scroll-m-0 relative mychat overflow-auto relative pt-0 z-0">
